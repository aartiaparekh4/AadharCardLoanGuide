      ...
      child: Row(
        ...
        children: [
          Container(
              ...
              child: Column(
                children: [
                  Text(title,textAlign:align,style: TextStyle(color: Colors.white, fontSize: 14),),
                  Gap(4),
                  Text("What is "+title+"?",textAlign:align,style: TextStyle(color: Colors.white, fontSize: 12),),
                ],
              )),
          Gap(32),
          Container(
              ...
              child: Text("Get More\nDetails",textAlign:TextAlign.center,style: TextStyle(color: Colors.white, fontSize: 10),)),
