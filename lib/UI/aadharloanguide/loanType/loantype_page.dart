                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      ...
                      child:Container(
                          ...
                          child: Row(
                            children: [
                              Utils.networkimageView(image: loanTypeLists[index].image.toString(),width: 22,height: 22),
                              Gap(12),
                              Text(loanTypeLists[index].name.toString(),textAlign:TextAlign.start,style: TextStyle(color: Colors.white, fontSize: 14),),
                            ],
                          )),
                    );
                  }))
